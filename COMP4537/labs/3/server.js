...
/**
 * APIServer Class handles Lab 3 logic using OOP principles.
 */
export class APIServer {
    constructor() {
        // You can initialize properties here if needed in the future
        this.logFile = 'File.txt';
    }

    /**
     * Main router for Lab 3 requests.
